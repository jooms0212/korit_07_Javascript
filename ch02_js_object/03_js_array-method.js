...
let pass = persons.filter(
  ...
  이상에서 주의할 점은 persons를 가지고 새로운 배열을 만들었는데, persons의 element의자료형은 object이므로, 새로운 배열인 pass의 element도 여전히 object입니다. score들을 가지고 비교했다고 해서 점수들을 element로 삼는 것이 아니라.
  */
